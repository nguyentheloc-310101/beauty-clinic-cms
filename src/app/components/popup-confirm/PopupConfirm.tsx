...
const PopUpConfirm = ({
  ...
  return (
    <>
      <div className="z-[1000] fixed top-0 left-0 w-full h-full bg-black/20 backdrop-blur-sm flex items-center">
        <div className="relative bg-white rounded-2xl w-fit mx-auto">
